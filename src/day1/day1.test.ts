...
Deno.test("applyTurn", async (t) => {
  const testCases = [
    { name: "99 to 0", startX: 99, turn: 1, expected: [0, 1] },
    { name: "0 to 99", startX: 0, turn: -1, expected: [99, 0] },
    { name: "0 to 1", startX: 0, turn: 1, expected: [1, 0] },
    { name: "1 to 0", startX: 1, turn: -1, expected: [0, 1] },
    { name: "99 to 0, double turn", startX: 99, turn: 101, expected: [0, 2] },
    { name: "99 to 0, 11 turns", startX: 99, turn: 1001, expected: [0, 11] },
    { name: "1 to 0, double negative turn", startX: 1, turn: -101, expected: [0, 2] },
    { name: "1 to 0, negative 11 turns", startX: 1, turn: -1001, expected: [0, 11] },
    { name: "99 start, negative 101 step turn", startX: 99, turn: -101, expected: [98, 1] },
    { name: "60 start, negative 150 step turn", startX: 60, turn: -150, expected: [10, 1] },
    ...
    { name: "turn positive beyond 100", startX: 50, turn: 80, expected: [30, 1] },
    { name: "multiple turns positive", startX: 50, turn: 350, expected: [0, 4] },
    { name: "start at 0, turn 100", startX: 0, turn: 100, expected: [0, 1] },
    { name: "start at 0, turn -100", startX: 0, turn: -100, expected: [0, 1] },
    { name: "small positive turn from zero", startX: 0, turn: 25, expected: [25, 0] },
    { name: "small negative turn from zero", startX: 0, turn: -25, expected: [75, 0] },
    { name: "starting at 99 and wrapping", startX: 99, turn: 50, expected: [49, 1] },
    { name: "landing on exactly 200", startX: 0, turn: 200, expected: [0, 2] },
    { name: "landing on exactly -200", startX: 0, turn: -200, expected: [0, 2] },
    { name: "large crossing positive to negative", startX: 10, turn: -300, expected: [10, 3] },
    { name: "from positive to exactly -100", startX: 50, turn: -150, expected: [0, 2] },
    { name: "edge case at 1", startX: 1, turn: -1, expected: [0, 1] },
